...
data = sqlctxt.sql("select client_name,fund_id,predicted_time,signal from {}.pxo_navnow_pricing_funds_predicted".format(database_m))
...
data_quant99 = sqlctxt.sql("select client_name,fund_id,max_predictedtime,signal from {}.pxo_navnow_pricing_funds_predicted".format(database_m))
...
sqlctxt.sql("truncate table {}.pxo_navnow_pricing_predicted".format(database_m))
data.select('client_name','weekday','quant_cumsum','red_5','red_10','red_20','predictd_cumsum','bin','signal')\
    .coalesce(1).write.insertInto("{}.pxo_navnow_pricing_predicted".format(database_m))
sc.stop()